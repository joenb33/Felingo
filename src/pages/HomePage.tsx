          ...
          <div className="text-center max-w-2xl mx-auto px-2">
            <h1 className="text-[3rem] font-extrabold leading-[1.05] tracking-[-2px] text-white sm:text-[4.5rem] md:text-[5.5rem]">
              ...
              <span
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(135deg, #BF5AF2 0%, #FF375F 60%, #FFD60A 100%)",
                }}
              >
                Felicia
              </span>
        ...
        <section className="pb-24 md:pb-16">
          ...
          >
            {sections.map((sectionKey) => {
              ...
              const progress =
                count > 0 ? Math.round((seenInSection / count) * 100) : 0;

              return (
                <motion.div key={sectionKey} variants={item}>
                  <Link
                    to={`/session/${sectionKey}`}
                    ...
                    <div
                      ...
                      onMouseEnter={(e) => {
                        ...
                        (e.currentTarget as HTMLDivElement).style.boxShadow =
                          `0 8px 40px rgba(0,0,0,0.55), 0 0 0 1px ${style.hoverBorder}, inset 0 1px 0 rgba(255,255,255,0.09)`;
              ...
              <Link to="/favorites" className="group block h-full">
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-[16px] font-semibold text-white tracking-[-0.2px]">
                      {ui.home.savedTitle}
                    </p>
                    <p className="mt-1 text-[13px] leading-snug text-[rgba(235,235,245,0.45)]">
                      {ui.home.savedDesc}
                    </p>
                  </div>
                  <svg
              ...
              <Link to="/panic" className="group block h-full">
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 text-[13px] leading-snug text-[rgba(235,235,245,0.45)]">
                      Korta fraser för stressiga stunder
                    </p>
                  </div>
                  <svg
                    width="16"
